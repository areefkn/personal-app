...
const SkillCard: React.FC<SkillProps> = ({skill,icon}) => {
    return (
        <div className="flex flex-col items-center p-5 sm:p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition-transform transform hover:scale-105 duration-300">
